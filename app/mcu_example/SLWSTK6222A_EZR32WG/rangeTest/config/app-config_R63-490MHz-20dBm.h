/***************************************************************************//**
 * @file app-config_R63-490MHz-20dBm.h
 * @brief Range Test application configuration for SLWSTK6223A kit.
 *
 * @version 5.2.2
 *******************************************************************************
 * # License
...
#define RANGETEST_RADIO_OUTPUT_POWER   "+20dBm"

// RSSI chart Y scale values
#define RANGETEST_RADIO_RSSI_MIN_VALUE "-110"
