...
RTCDRV_TimerID_t xTimerIdForWakeUp;
...
int main(void)
{
  ...
  for( i=0; i < 50; i++)
  {
    RTCDRV_StartTimer( xTimerIdForWakeUp, rtcdrvTimerTypeOneshot, 10, NULL, NULL);
    EMU_EnterEM2(true);
    RTCDRV_Delay( 10);
  }
  ...
  for( i=0; i < 500; i++)
  {
    RTCDRV_StartTimer( xTimerIdForWakeUp, rtcdrvTimerTypeOneshot, 2, NULL, NULL);
    EMU_EnterEM2(true);
  }
  ...
  for( i=0; i < 1000; i++)
  {
    RTCDRV_StartTimer( xTimerIdForWakeUp, rtcdrvTimerTypeOneshot, 1, NULL, NULL);
    EMU_EnterEM2(true);
  }
