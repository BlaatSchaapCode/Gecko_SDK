...
uint32_t EXP_SI72XX_placeSensorsInLatchMode(void)
{
  ...
  i2cError = Si72xx_EnterLatchMode(I2C0, SI7200_ADDR_1);
  i2cError |= Si72xx_EnterLatchMode(I2C0, SI7200_ADDR_2);
...
uint32_t EXP_SI72XX_placeSensorsInSleepMode(void)
{
  ...
  i2cError = Si72xx_EnterSleepMode(I2C0, SI7200_ADDR_1, SI72XX_SLEEP_MODE);
  i2cError |= Si72xx_EnterSleepMode(I2C0, SI7200_ADDR_2, SI72XX_SLEEP_MODE);
...
void EXP_SI72XX_runAngleDemo(void)
{
  ...
  i2cError = Si72xx_ReadMagFieldDataAndSleep(I2C0,
                                             SI7200_ADDR_1,
                                             SI7210_20MT,
                                             SI72XX_SLEEP_MODE,
                                             &dataU1);
  i2cError |= Si72xx_ReadMagFieldDataAndSleep(I2C0,
                                              ...
                                              &dataU2);
  if (!i2cError) {
    magFieldU1 = Si72xx_ConvertDataCodesToMagneticField(SI7210_20MT, dataU1);
    magFieldU2 = Si72xx_ConvertDataCodesToMagneticField(SI7210_20MT, dataU2);
