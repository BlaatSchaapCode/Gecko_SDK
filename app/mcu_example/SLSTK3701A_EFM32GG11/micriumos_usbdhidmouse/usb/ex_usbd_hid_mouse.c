...
#ifndef RTOS_MODULE_USB_DEV_HID_AVAIL
#error "RTOS_MODULE_USB_DEV_HID_AVAIL must be defined in rtos_description.h and present in your project to use this example."
#endif
...
*
* Description : Adds an HID interface that represents a mouse to the device.
*
* Argument(s) : dev_nbr         Device number.
*
*               cfg_nbr_fs      Full-Speed configuration number.
*
*               cfg_nbr_hs      High-Speed configuration number.
*
* Return(s)   : None.
*
* Caller(s)   : Application.
*
* Note(s)     : (1) The examle creates a task that will send periodic reports that emulates a mous that
...
*
* Argument(s) : p_arg       Task argument. Class number in this case.
*
* Return(s)   : None.
*
...
*
*               report_len      Length of report, in octets.
*
