 ...
 * function board. This demo runs on the EFM32GG STK, and communicates
 ...
 *
 * ----------------------------------------------------------------------------
 * How To Test: EFM32GG STK
 * ----------------------------------------------------------------------------
 * 1) Place the switch in "DBG" mode.
 * 2) Attach CPT007B to STK through EXP headers
 * 3) Connect the EFM32GG STK board to a PC using a mini USB cable.
 * 4) Compile and download code to the EFM32GG STK board.
