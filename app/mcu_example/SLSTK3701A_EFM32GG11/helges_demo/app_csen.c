...
static const CSEN_SingleSel_TypeDef sliderInpChannels[] = { csenSingleSelAPORT1XCH22, csenSingleSelAPORT1YCH31, csenSingleSelAPORT1XCH20, csenSingleSelAPORT1YCH7 };
...
void setupCSEN(void)
{
  ...
  csenMeasureModeInit.inputMask0 = (1U << 31) | (1U << 22) | (1U << 20) | (1U << 7);
