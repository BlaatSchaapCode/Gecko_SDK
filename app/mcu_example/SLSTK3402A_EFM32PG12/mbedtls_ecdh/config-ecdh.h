/*
 *  Configuration for enabling CRYPTO hardware acceleration in ECDH(E) example.
 *
 ...
 *
 * Enable hardware entropy source (e.g. TRNG if present, radio (RAIL) or
 * dummy entropy as last resort).
 */
