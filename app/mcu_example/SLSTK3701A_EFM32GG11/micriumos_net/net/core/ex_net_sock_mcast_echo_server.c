...
*
* File : ex_net_sock_mcast_echo_server.c
...
*
* Description : Create an UDP Multicast echo server using IPv4 string address.
*
* Argument(s) : p_name          String containing interface controller's name.
*
*               p_group_addr    String with IPv4 multicast address of group to use.
*
*               port            Network port number to use.
*
* Return(s)   : none.
*
* Note(s)     : none.
