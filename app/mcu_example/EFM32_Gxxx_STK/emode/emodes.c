...
/***************************************************************************//**
 * @brief
 *   Enter EM0 with HFXO running at 32MHz.
 *
 * @details
 *   Parameter:
 ...
 *   Condition:
 *     32 MHz HFXO, all peripheral clocks disabled, VDD= 3.0V.@n
 *
 * @note
...
/***************************************************************************//**
 * @brief
 *   Enter EM1 with HFXO running at 32MHz.
 *
 * @details
 *   Parameter:
       EM1 (Production test condition = 14 MHz).@n
 *   Condition:
 *     32 MHz HFXO, all peripheral clocks disabled, VDD= 3.0 V.@n
 *
 * @note
 *   To better understand disabling clocks and oscillators for specific modes,
 *   see Reference Manual section EMU-Energy Management Unit and Table 10.1.
 ...
 *   Parameter:
       EM3.@n
 *   Condition:
 *     VDD= 3.0 V, LFRCO/LFXO disabled.@n
 *
 * @note
 *   To better understand disabling clocks and oscillators for specific modes,
 *   see Reference Manual section EMU-Energy Management Unit and Table 10.1.
