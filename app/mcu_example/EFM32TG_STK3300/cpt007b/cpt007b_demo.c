 ...
 * function board. This demo runs on the EFM32TG STK, and communicates
 ...
 *
 * ----------------------------------------------------------------------------
 * How To Test: EFM32TG STK
 * ----------------------------------------------------------------------------
 * 1) Place the SW104 switch in "AEM" mode.
 * 2) Attach CPT007B to STK through EXP headers
 * 3) Connect the EFM32TG STK board to a PC using a mini USB cable.
 * 4) Compile and download code to the EFM32TG STK board.
