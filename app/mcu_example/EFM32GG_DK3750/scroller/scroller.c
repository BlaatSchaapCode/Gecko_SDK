/**************************************************************************//**
 * @file
 * @brief TFT Direct Drive horizontal scroller for Giant Gecko / Leopard Gecko
 *        EFM32GG-DK3750 development kit. This demo uses the HSYNC interrupt
...
const char *scrolltext = " The Silicon Labs Simplicity Team brings you the "
                         "EFM32GG-DK3750 development kit, with cool TFT direct drive features.....";
