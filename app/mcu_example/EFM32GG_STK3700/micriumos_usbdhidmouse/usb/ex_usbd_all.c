...
#ifndef RTOS_MODULE_USB_DEV_AVAIL
#error "RTOS_MODULE_USB_DEV_AVAIL must be defined in rtos_description.h and present in your project to use this example."
#endif
...
void  Ex_USBD_HID_Init      (CPU_INT08U  dev_nbr,
    ...
    defined(RTOS_MODULE_USB_DEV_ACM_AVAIL)
...
#ifdef RTOS_MODULE_USB_DEV_ACM_AVAIL
    cfg_usbd_dev.ProductID          =  0x1234u;
#elif defined(RTOS_MODULE_USB_DEV_VENDOR_AVAIL)
