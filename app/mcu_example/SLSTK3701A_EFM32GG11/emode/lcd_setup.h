...
typedef enum {
  EM0_HFXO_50MHZ_WHILE,          /**< EM0 with HFXO at 50MHz (while loop)                    */
  EM0_HFRCO_72MHZ_PRIME,         /**< EM0 with HFRCO at 72MHz (prime calculations)           */
  EM0_HFRCO_72MHZ_WHILE,         /**< EM0 with HFRCO at 72MHz (while loop)                   */
  EM0_HFRCO_72MHZ_COREMARK,      /**< EM0 with HFRCO at 72MHz (Coremark)                     */
  EM0_HFRCO_64MHZ_WHILE,         /**< EM0 with HFRCO at 64MHz (while loop)                   */
  EM0_HFRCO_56MHZ_WHILE,         /**< EM0 with HFRCO at 56MHz (while loop)                   */
  ...
  EM1_HFXO_50MHZ,                /**< EM1 with HFXO at 50MHz                                 */
  EM1_HFRCO_72MHZ,               /**< EM1 with HFRCO at 72MHz                                */
  EM1_HFRCO_64MHZ,               /**< EM1 with HFRCO at 64MHz                                */
  EM1_HFRCO_56MHZ,               /**< EM1 with HFRCO at 56MHz                                */
  ...
  EM0_HFXO_50MHZ_WHILE_DCDC,     /**< EM0 with HFXO at 50MHz with DCDC (while loop)          */
  EM0_HFRCO_72MHZ_PRIME_DCDC,    /**< EM0 with HFRCO at 72MHz with DCDC (prime calculations) */
  EM0_HFRCO_72MHZ_WHILE_DCDC,    /**< EM0 with HFRCO at 38MHz with DCDC (while loop)         */
  EM0_HFRCO_72MHZ_COREMARK_DCDC, /**< EM0 with HFRCO at 72MHz with DCDC (Coremark)           */
  EM0_HFRCO_64MHZ_WHILE_DCDC,    /**< EM0 with HFRCO at 38MHz with DCDC (while loop)         */
  EM0_HFRCO_56MHZ_WHILE_DCDC,    /**< EM0 with HFRCO at 38MHz with DCDC (while loop)         */
  EM0_HFRCO_48MHZ_WHILE_DCDC,    /**< EM0 with HFRCO at 38MHz with DCDC (while loop)         */
  ...
  EM1_HFXO_50MHZ_DCDC,           /**< EM1 with HFXO at 40MHz with DCDC                       */
  EM1_HFRCO_72MHZ_DCDC,          /**< EM1 with HFRCO at 38MHz with DCDC                      */
  EM1_HFRCO_64MHZ_DCDC,          /**< EM1 with HFRCO at 38MHz with DCDC                      */
  EM1_HFRCO_56MHZ_DCDC,          /**< EM1 with HFRCO at 38MHz with DCDC                      */
  EM1_HFRCO_48MHZ_DCDC,          /**< EM1 with HFRCO at 38MHz with DCDC                      */
