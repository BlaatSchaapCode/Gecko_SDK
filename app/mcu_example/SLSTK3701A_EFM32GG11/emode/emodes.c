/***************************************************************************//**
 * @file emodes.c
 * @brief Giant Gecko 11 energy mode setups (See Data Sheet Table tbd)
 * @version 5.6.1
 *******************************************************************************
 * # License
...
/***************************************************************************//**
 * @brief
 *   Enter EM0 with HFXO running at 50 MHz.
 *
 * @details
 *   Parameter:
 *     EM0. Active Mode. All peripherals disabled.@n
 *   Condition:
 *     50 MHz HFXO, all peripheral clocks disabled.@n
 *
 * @note
 ...
 *
 * @param[in] band
 *   HFRCO frequency to activate (72, 64, 56, 48, 38, 32, 26, 19, 16, 13, 7, 4, 2, 1 MHz).
 *
 * @details
 *   Parameter:
 *     EM0. Active Mode. All peripherals disabled.@n
 *   Condition:
 *     Between 72 and 1 MHz HFRCO, all peripheral clocks disabled.@n
 *
 * @note
 *   To better understand disabling clocks and oscillators for specific modes,
 *   see Reference Manual section EMU-Energy Management Unit and Table 9.2.
...
/***************************************************************************//**
 * @brief
 *   Enter EM1 with HFXO running at 50 MHz.
 *
 * @details
 *   Parameter:
 ...
 *   Powerdown from full RAM to 16kB RAM if true, else retain full RAM.
 *
 * @details
 *   Parameter:
