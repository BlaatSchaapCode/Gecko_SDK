/***************************************************************************//**
 * @file emodes.c
 * @brief Tiny Gecko 11 energy mode setups
 * @version 5.6.1
 *******************************************************************************
 * # License
...
/***************************************************************************//**
 * @brief
 *   Enter EM0 with HFXO running at 48 MHz.
 *
 * @details
 *   Parameter:
 *     EM0. Active Mode. All peripherals disabled.@n
 *   Condition:
 *     48 MHz HFXO, all peripheral clocks disabled.@n
 *
 * @note
 *   To better understand disabling clocks and oscillators for specific modes,
 *   see Reference Manual section EMU-Energy Management Unit.
 ******************************************************************************/
 ...
 *
 * @param[in] band
 *   HFRCO frequency to activate (48, 19, 1 MHz).
 *
 * @details
 *   Parameter:
 *     EM0. Active Mode. All peripherals disabled.@n
 *   Condition:
 *     Between 48 and 1 MHz HFRCO, all peripheral clocks disabled.@n
 *
 * @note
 *   To better understand disabling clocks and oscillators for specific modes,
 *   see Reference Manual section EMU-Energy Management Unit.
...
/***************************************************************************//**
 * @brief
 *   Enter EM1 with HFXO running at 48 MHz.
 *
 * @details
 *   Parameter:
 ...
 *   Powerdown from full RAM to 8kB RAM if true, else retain full RAM.
 *
 * @details
 *   Parameter:
...
void em_EM2_RTCC(CMU_Select_TypeDef osc, bool powerdownRam)
{
  ...
  // Initialize RTCC. Configure RTCC with prescaler 32.
  RTCC_Init(&rtccInit);
