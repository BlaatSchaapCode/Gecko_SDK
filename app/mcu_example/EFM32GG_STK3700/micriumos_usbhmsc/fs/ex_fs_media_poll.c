...
#endif
#if defined(RTOS_MODULE_FS_SD_CARD_AVAIL) || \
...
*                                         Ex_FS_MediaPollInit()
*
* Description : Initialize and create resources needed by the Media Poll example.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
*                                          Ex_FS_MediaOnConn()
*
* Description : Callback called by the file system upon connection of a removable media.
*
...
*
* Description : Callback called by the file system upon disconnection of a removable media.
*
* Argument(s) : media_handle    Handle to a media.
*
* Return(s)   : none.
...
*                                     Ex_FS_MediaPollTaskHandler()
*
* Description : Media Poll task handler.
*
* Argument(s) : p_arg   Pointer to task's argument.
*
* Return(s)   : none.
*
* Note(s)     : none.
