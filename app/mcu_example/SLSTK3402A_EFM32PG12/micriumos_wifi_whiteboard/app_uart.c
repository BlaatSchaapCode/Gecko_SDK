...
static void AppUartSetup(void)
{
  ...
  // Configure routes.
  usart->ROUTELOC0 = USART_ROUTELOC0_RXLOC_LOC18
                     | USART_ROUTELOC0_TXLOC_LOC18
                     | USART_ROUTELOC0_CLKLOC_LOC18
                     | USART_ROUTELOC0_CSLOC_LOC18;

  usart->ROUTELOC1 = USART_ROUTELOC1_CTSLOC_LOC10
                     | USART_ROUTELOC1_RTSLOC_LOC12;
  ...
  CPU_IntSrcHandlerSetKA(USART0_RX_IRQn + 16, USART0_RX_IRQHandler);
